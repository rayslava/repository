...
DESCRIPTION="Robomongo shell is a fork of MongoDB to provide shell for Robomongo."
...
if [[ ${PV} == "9999" ]]; then
	...
	MY_P=${PN}-r${MY_PV}
	SRC_URI="https://github.com/paralect/${PN}/archive/r${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
fi
